...
const values = new Map([
  ...
  ['7', ({ size, color, styleClass }) => <FontAwesome5 name='feather-alt' size={size} color={color} style={styleClass} key='feather-alt' />],
  // ['7', ({ size, color, styleClass }) => <Ionicons name='ios-people' size={size} color={color} style={styleClass} key='ios-people' />],
  ['6', ({ size, color, styleClass }) => <FontAwesome5 name='shapes' size={size} color={color} style={styleClass} key='shapes' />],
